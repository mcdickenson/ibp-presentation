...
\item Each pair of layers is conditionally represented by a 2-parameter IBP
\item They prove that the generative process terminates at finite ``depth''
\item They present MCMC algorithms for inference and test on images
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
